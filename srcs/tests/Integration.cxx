//
// Created by plouvel on 12/19/24.
//
...
Addr_00F4:
    ...
    */
    ...
    bus.write(0, {0x31, 0xFE, 0xFF, 0xAF, 0x21, 0xFF, 0x9F, 0x32, 0xCB, 0x7C, 0x20, 0xFB, 0x21, 0x26, 0xFF, 0x0E,
...
//     const auto a = cpu.disassemble(0, 0xFF);
//
//     for (const auto& [addr, name] : a)
//     {
//         std::clog << std::hex << std::setfill('0') << std::setw(4) << addr << ": ";
